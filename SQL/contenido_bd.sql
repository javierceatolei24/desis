CREATE TABLE IF NOT EXISTS `votante` (
  ...
  `vot_nombre` varchar(50) NOT NULL,
  `vot_alias` varchar(50) NOT NULL,
  `vot_rut` varchar(50) NOT NULL,
  `vot_email` varchar(50) NOT NULL,
  `vot_region` varchar(50) NOT NULL,
  `vot_comuna` varchar(50) NOT NULL,
  `vot_candidato` varchar(50) NOT NULL,
  `vot_canales` varchar(50) NOT NULL,
  PRIMARY KEY (`vot_id`)
)
...
INSERT INTO `candidatos` (`id`,`candidato`)
VALUES
	(1,'CANDIDATO 1'),
	(2,'CANDIDATO 2'),
	(3,'CANDIDATO 3');
...
INSERT INTO `regiones` (`id`,`region`)
VALUES
...
INSERT INTO `comunas` (`id`, `comuna`, `region_id`)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',1),
